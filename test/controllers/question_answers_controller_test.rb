...
class QuestionAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_answer" do
    assert_difference('QuestionAnswer.count') do
      post question_answers_url, params: { question_answer: { givenAnswer: @question_answer.givenAnswer, question_id: @question_answer.question_id, timeEnded: @question_answer.timeEnded, timeStarted: @question_answer.timeStarted, user_id: @question_answer.user_id } }
    end
  ...
  test "should update question_answer" do
    patch question_answer_url(@question_answer), params: { question_answer: { givenAnswer: @question_answer.givenAnswer, question_id: @question_answer.question_id, timeEnded: @question_answer.timeEnded, timeStarted: @question_answer.timeStarted, user_id: @question_answer.user_id } }
